<%@ Page Title="" Language="C#" MasterPageFile="~/Jobprovider/provider.master" AutoEventWireup="true" CodeFile="communication.aspx.cs" Inherits="Jobprovider_communication" %>
...
<div style=" background-color:#A03040; height:30px; width:120px; position:absolute; margin-left:80%;"><asp:Button ID="Button2" runat="server" Text="Inbox" ForeColor="White" BackColor="#A03040" Height="30" Width="120" CssClass="nob" onclick="inboxc" /></div>
<div style=" background-color:#A03040; height:30px; width:120px; position:absolute; margin-left:92%;"><asp:Button ID="Button3" runat="server" Text="Compose" ForeColor="White" BackColor="#A03040" Height="30" Width="120" OnClick="composec" CssClass="nob" /></div>
<div style=" background-color:#A03040; height:30px; width:120px; position:absolute; margin-left:104%;"><asp:Button ID="Button4" runat="server" Text="Sent Mail" ForeColor="White" BackColor="#A03040" Height="30" Width="120" OnClick="sentc" CssClass="nob" /></div>
<div style=" background-color:#A03040; height:30px; width:120px; position:absolute; margin-left:92%; margin-top:51%;"><asp:Button ID="btnreply" runat="server" Text="Reply" ForeColor="White" BackColor="#A03040" Height="30" Width="120" OnClick="btnrpy" CssClass="nob" /></div>
<div style=" background-color:#A03040; height:30px; width:120px; position:absolute; margin-left:104%; margin-top:51%;"><asp:Button ID="Button5" runat="server" Text="Clear" ForeColor="White" BackColor="#A03040" Height="30" Width="120" CssClass="nob" /></div>
...
<asp:Panel ID="pnlinbox" runat="server">
		...
		<div style=" width:470px; height:26px; background-color:#1ab188;margin-top:11%; margin-left:137%; ">
                <h5 style="color:White; text-align:center; padding-top:4px; margin-top:1%; ">&nbsp MESSAGE</h5></div>
                 ...
                 <asp:Label ID="lblviewcontent" runat="server" CssClass="lbl" Width="300" Height="200"></asp:Label>
