<%@ Page Title="" Language="C#" MasterPageFile="~/Jobprovider/provider.master" AutoEventWireup="true" CodeFile="sentmail.aspx.cs" Inherits="Jobprovider_sentmail" %>
...
<div style=" background-color:#f6b440; height:30px; width:120px; position:absolute; margin-top:42%;">
    <asp:Button ID="Button5" runat="server" Text="Clear" OnClick="clear" ForeColor="White" BackColor="#A03040" Height="30" Width="120" CssClass="nob" /></div>


<div style=" background-color:#383860; height:460px; width:1140px; position:absolute; margin-top:3%; ">
