...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-top:-14.8%; margin-left:3%; Height:580px; Width:1200px; border:1px solid White;">
    
    <div style=" height:90%; width:90%; background-color:white; margin-top:1%; margin-left:5%; ">
    <div style=" height:10%;  width:55%; background-color:#383860; border-radius:50px; margin-top:4%; margin-left:15%">
        <div style=" background-color:White; border-radius:200px; height:170px; width:170px; margin-top:-58px; position:absolute; margin-left:275px; top: -103px; left: 194px;">
        <h1 style=" position:absolute; margin-left:30px; margin-top:70px; top: -5px; left: -12px;">ADD JOB</h1>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="jobadd" ForeColor="Red" ErrorMessage="Enter the Job Name"></asp:RequiredFieldValidator>
        </div>    
