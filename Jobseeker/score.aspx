<%@ Page Language="C#" AutoEventWireup="true" CodeFile="score.aspx.cs" Inherits="Jobseeker_score" %>
...
<form id="Form1" runat="server">
    <div style=" font-size:0;">
        ...
        <div style="width:68%; height:600px; background-color:#f6f6f6; display:inline-block; ">
        
            <asp:Image ID="Image4" runat="server" ImageUrl="~/images/res.jpg" Height="500" Width="800" CssClass="mgg" />
            <h4 style=" font-size:medium; margin-left:20%; margin-top:-35%;">MAXIMUM SCORE:</h4><asp:Label ID="Label7" runat="server" CssClass="maxs"></asp:Label>
            <h4 style=" font-size:medium; margin-left:20%;">YOUR SCORE:</h4><asp:Label ID="Label8" runat="server" CssClass="mins"></asp:Label>
            </div>
