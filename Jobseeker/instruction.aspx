<%@ Page Language="C#" AutoEventWireup="true" CodeFile="instruction.aspx.cs" Inherits="Jobseeker_dashboard" %>
...
<form id="Form1" runat="server">
    <div style=" font-size:0;">
        ...
        <h4>ONLINE EXAM RULES</h4>
        <p style=" margin-left:4%; color:Maroon;">
        1.Accesses to a personal computer with internet connectivity which in addition has to have a functioning keyboard and mouse.<br /><br />
        2.All such computers must be tested by attempting online practice examinations/ mock exam well in advance to the date of the<br />
          final exam to allow time to correct any technical problems with software and/or hardware<br /><br />
        3.Top Score Method: In the normal course, the participant with the higher score in shortest time span for the given exam track<br />
          will be shortlisted for next level. However, in the event of two or more participants getting the same score, the one who completes<br />
          the same in the shortest time will be given priority in selection.<br /><br />
        4.The selection criteria of such tests will be announced prior to the date of examination for the applicable level.<br /><br />
        5.The top 3 scorers in each category from each school or junior college shall be eligible to participate in the final round of the contest.<br /><br />
